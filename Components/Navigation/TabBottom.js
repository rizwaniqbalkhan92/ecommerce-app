...
import Kids  from '../Catgories/Kids'
...
const StackAllProducts=()=>{
    ...
    return(
        <AllProductsStack.Navigator   screenOptions={{
            ...
            <AllProductsStack.Screen  name='Final' component={Final}  />
            {/* <AllProductsStack.Screen  name='Details' component={Detail}  /> */}
        ...
        <CategoriesStack.Navigator
         screenOptions={{
            headerShown: false
              ...
              <CategoriesStack.Screen name='Kids' component={Kids}   />
...
const AddToCardAll=()=>{
    ...
    return(
<AddtoCardAll.Navigator  screenOptions={{
            headerShown: false
          }}>
