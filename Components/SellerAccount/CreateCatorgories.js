import { TextArea,NativeBaseProvider,Center,  Card,Button, Select,
    VStack,
...
const CreateCatorgories = () => {
    ...
    return (
        ...
        <VStack alignItems="center" style={styles.cat0}  space={4}>
      <Select style={styles.cat}
      ...
      >
        <Select.Item label="Shoes" value="ux" />
        <Select.Item label="Clothes" value="web" />
        <Select.Item label="Accessories" value="cross" />
        <Select.Item label="UI Designing" value="ui" />
        <Select.Item label="Backend Development" value="backend" />
      </Select>
    </VStack>
    <View>
             <TextInput style={styles.inp1} placeholder='Category Name' />
        
         </View>
 <Card style={styles.cards}>
     <Card style={styles.card1}>
     <Button style={styles.btnCard} >Image1</Button>
     <Image source={{uri:img}} resizeMode='contain'  style={styles.catImges}  />
     </Card>
     <Card style={styles.card1}>
     <Button style={styles.btnCard} >Image1</Button>
     <Image source={{uri:img}} resizeMode='contain'  style={styles.catImges}  />
     ...
     <Image source={{uri:img}} resizeMode='contain'  style={styles.catImges}  />
         ...
         <TouchableOpacity style={styles.btnCreate}>
             <Text style={styles.btnCreateText}>Create Categories</Text>
         </TouchableOpacity>
         </View>
             </NativeBaseProvider>
         </ScrollView>
...
export default CreateCatorgories
