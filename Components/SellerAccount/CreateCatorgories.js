     ...
     <Center>
                    ...
                    <VStack alignItems="center" style={styles.cat0} space={4}>
                        ...
                        >
                            ...
                            <Select.Item label="Electronics" value="ui" />
                            <Select.Item label="Bags" value="backend" />
                        </Select>
                    </VStack>
                    <View>
                        <TextInput style={styles.inp1} onChangeText={e => setCategoryName(e.targwet.value)} placeholder='Category Name' />
