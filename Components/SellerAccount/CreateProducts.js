    ...
    return (
        ...
        <NativeBaseProvider>
            <View>
                ...
                <View>
                    <TextInput style={styles.inp1} onChangeText={e=>setProductName(e)} placeholder='Product Name' />
                    <TextInput style={styles.inp1}  onChange={e=>setProductPrice(e)} placeholder='Product Price' />
                    <TextArea style={styles.text1}  onChange={e=>setProductDescription(e)} placeholder='Product Descriptions' />
                </View>

                {/* <Image source={}  /> */}
                <TouchableOpacity style={styles.btnCreate}>
                    <Text style={styles.btnCreateText} onPress={createProduct}  >Create Product</Text>
                </TouchableOpacity>
            </View>
        </NativeBaseProvider>
    </ScrollView>
