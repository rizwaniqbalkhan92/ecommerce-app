...
const CreateProducts = () => {
    ...
    return (
       ...
       <NativeBaseProvider>
        ...
        <View>
            <TextInput style={styles.inp1} placeholder='Product Name' />
            <TextInput style={styles.inp1} placeholder='Product Price' />
            <TextArea style={styles.text1} placeholder='Product Price' />
        </View>
